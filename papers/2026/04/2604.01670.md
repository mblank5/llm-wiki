...
authors: ["Junming Liu", "Shanghai Artificial Intelligence Laboratory", "Shanghai", "China", ",", "Yifei Sun", "Weihua Cheng", "Haodong Lei", "Yuqi Li", "The City University of New York", "New York", "USA", "Yirong Chen", "and", "Ding Wang"]
...
Abstract. While long-term memory is essential for intelligent agents to maintain consistent historical awareness, the accumulation of extensive interaction data often leads to performance bottlenecks.
...
Figure: Figure 2. The system architecture and operational workflow of HMO.
Refer to caption: 2604.01670v1/x2.png

## 3. Methods

HMO formalizes the memory lifecycle through four phases: autonomous ingestion, hierarchical redistribution, adaptive scoring, and incremental evolution, as illustrated in Figure [2](#S2.F2).
...
where $f_{\text{M}}$ denotes a MLLM that compresses interactions into specialized cognitive representations, such as semantic, episodic, or core memories (Packer et al., 2024; Wang and Chen, 2025; Liu et al., 2025).
...
The detailed scoring criteria are provided in Appendix A. We distinguish $I_{m}$ from the continuous semantic alignment $\text{Sim}(m,P)$, as empirical tests indicate that initialization based only on similarity is limited because an MLLM better accounts for more dimensions during initial scoring.
...
Consequently, we utilize $\mathcal{E}$ for initialization while relying on cosine similarity for efficient, real-time updates. Each record $m$ is then initialized with a header $\mathcal{H}_{m}$:
...
| Method | Retriever | Rec@5 $\uparrow$ | NDCG@5 $\uparrow$ | Acc. $\uparrow$ |
| --- | --- | --- | --- | --- |
| No History (Tan et al., 2025) | - | - | - | 0.0 |
| Long Context (Tan et al., 2025) | - | - | - | 57.4 |
| RAG (Tan et al., 2025) | Stella | 59.2 | - | 61.4 |
| RAG (Tan et al., 2025) | GTE | 62.4 | - | 63.6 |
| MemoryBank (Tan et al., 2025) | Specific1 | 58.6 | - | 59.6 |
| LD-Agent (Tan et al., 2025) | Specific2 | 56.8 | - | 59.2 |
| A-Mem (Li et al., 2026) | Qwen3-0.6B | - | - | 55.4 |
| Mem0 (Li et al., 2026) | Qwen3-0.6B | - | - | 65.0 |
| MemoryOS (Li et al., 2026) | Qwen3-0.6B | - | - | 58.0 |
| MemOS (Li et al., 2026) | Qwen3-0.6B | - | - | 68.7 |
| RMM (Tan et al., 2025) | GTE | 69.8 | - | 70.4 |
| QRRetriever (Zhang et al., 2025) | Llama-3.1-70B | 80.4 | - | 66.7 |
| HMO (Ours) | TE-small | 81.1 | 85.6 | 86.4 |
...
The hyperparameters are configured as $\alpha=1$, $\beta=1$, and $\tau=0.10$. For the hierarchical storage, we set the primary tier size to $S=5$ and $K=50$, with the secondary storage capacity defined as $H=200$.

Figure: Figure 3. Demonstration of HMO application on OpenClaw, with a simple and informative user interface.
Refer to caption: 2604.01670v1/x3.png
...
Vol. 30, pp. .
External Links: [Link](https://proceedings.neurips.cc/paper_files/paper/2017/file/d5e2c0adad503c91f91df240d0cd4e49-Paper.pdf)
Cited by: [§1](#S1.p2.1).
...
[Link](https://doi.org/10.1145/3706599.3720158),
[Document](https://dx.doi.org/10.1145/3706599.3720158)
Cited by: [§1](#S1.p1.1).
...
Cited by: [Table 5](#A1.T5.5.6.4.1),
[§4.1](#S4.SS1.p2.1).
...
Cited by: [Table 1](#S3.T1.3.10.7.1),
[Table 1](#S3.T1.3.11.8.1),
[Table 1](#S3.T1.3.12.9.1),
[Table 1](#S3.T1.3.13.10.1).
...
Cited by: [Table 5](#A1.T5.5.7.5.1),
[§1](#S1.p2.1),
[§1](#S1.p3.1),
[§2.2](#S2.SS2.p1.1),
[§3.1](#S3.SS1.p1.4),
[§4.1](#S4.SS1.p2.1),
[Table 2](#S4.T2.1.2.1.1),
[Table 2](#S4.T2.1.3.2.1),
[Table 2](#S4.T2.1.4.3.1),
[Table 2](#S4.T2.1.5.4.1),
[Table 2](#S4.T2.1.6.5.1).
...
[Link](https://doi.org/10.1145/3696410.3714805),
[Document](https://dx.doi.org/10.1145/3696410.3714805)
Cited by: [§2.1](#S2.SS1.p1.1).
...
[Table 1](#S3.T1.3.14.11.1),
[Table 1](#S3.T1.3.4.1.1),
[Table 1](#S3.T1.3.5.2.1),
[Table 1](#S3.T1.3.6.3.1),
[Table 1](#S3.T1.3.7.4.1),
[Table 1](#S3.T1.3.8.5.1),
[Table 1](#S3.T1.3.9.6.1),
[§4.1](#S4.SS1.p2.1).
...
[Link](https://doi.org/10.1145/3544548.3580895),
[Document](https://dx.doi.org/10.1145/3544548.3580895)
Cited by: [§1](#S1.p1.1).
...
Cited by: [Table 5](#A1.T5.5.3.1.1),
[Table 5](#A1.T5.5.4.2.1),
[§4.1](#S4.SS1.p2.1).
...
External Links: [Link](https://aclanthology.org/2025.emnlp-main.1214/),
[Document](https://dx.doi.org/10.18653/v1/2025.emnlp-main.1214),
ISBN 979-8-89176-332-6
Cited by: [Table 1](#S3.T1.3.15.12.1),
[§4.1](#S4.SS1.p2.1).
- Y. Zheng, Y. Chen, B. Qian, X. Shi, Y. Shu, and J. Chen (2025)
A review on edge large language models: design, execution, and applications.
ACM Comput. Surv. 57 (8).
External Links: ISSN 0360-0300,
[Link](https://doi.org/10.1145/3719664),
[Document](https://dx.doi.org/10.1145/3719664)
Cited by: [§1](#S1.p2.1).
...
[Link](https://doi.org/10.1145/3613904.3642450),
[Document](https://dx.doi.org/10.1145/3613904.3642450)
Cited by: [§2.1](#S2.SS1.p1.1).
...
| A-Mem (Xu et al., 2025a) | 44.65 | 27.02 | 45.85 | 12.14 | 23.30 |
| MemoryBank (Xu et al., 2025a) | 41.04 | 26.65 | 25.52 | 9.15 | 31.42 |
| Mem0 (Chhikara et al., 2025) | 38.72 | 28.64 | 48.93 | 47.65 | 42.13 |
| MemoryOS (Kang et al., 2025b) | 35.27 | 41.15 | 20.02 | 48.62 | 42.84 |
| MemVerse (Liu et al., 2025) | 46.11 | 29.69 | 30.84 | 49.23 | 43.44 |
| HMO (Ours) | 48.24 | 32.15 | 35.66 | 51.08 | 45.65 |

**Table 6. Prompt template for MLLM-based initial importance scoring.**
| Initial Importance Scoring Evaluator $\mathcal{E}$ |
| --- |
| Role |
| You are an expert Cognitive Memory Engine. Your task is to evaluate a new interaction record between a User and an AI Agent to determine its “Initial Importance” ($I_{m}$) for long-term retention. |
| Context |
| $\bullet$ User Persona ($P$): {{user_persona}} |
| $\bullet$ Interaction Record ($m$): {{memory_content}} |
| Scoring Dimensions |
...
As illustrated in Figure [4](#A4.F4) and Figure [5](#A4.F5), we provide additional examples of the system interface across various interaction scenarios. These cases demonstrate the consistent performance of HMO when dealing with different user types and dialogue topics.
...
Figure: Figure 4. System interface demonstration (example 1).
Refer to caption: 2604.01670v1/x4.png

Figure: Figure 5. System interface demonstration (example 2).
Refer to caption: 2604.01670v1/x5.png